				...
				<div class="row">
					...
					<div class="col-md-12 col-xl-8" style="margin:auto;">
						<div class="bg-secondary rounded h-100 p-4">
								<h6 style="text-align:center;color:green">*********** Payment Receipt ***********</h6>
							<table>
								<tr>
								...
								<tr>
									...
									<td>: <c:out value="${transaction.loanAmount}" /></td>
								</tr>
								<tr>
									<td>Interest Rate</td>
									<td>: <c:out value="${transaction.interestRate}" /></td>
								</tr>
								<tr>
									<td>Next Interest Amount</td>
									<td>: <c:out value="${transaction.interestAmount }" /></td>
								</tr>
								<tr>
									<td>Next Due Date</td>
									<td>: <c:out value="${transaction.dueDate}" /></td>
								</tr>
								<tr>
