			...
			<div class="container-fluid pt-4 px-4">
				<div class="row g-4S">
					...
					<div class="bg-secondary rounded h-100 p-4">
			            ...
			            <c:if test="${empty msg }">
						 <h6 class="mb-4" style="color:red">Missing Payment details</h6>
						</c:if>
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th scope="col" style="color:red">Due Date</th>
								...
								<tbody>
									...
									<c:forEach items="${customerList}" var="customer">
										<tr>
											...
											<td style="color:red"><c:out value="${customer.dueDate }" /></td>
											<td><c:out value="${days }" /> day</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
