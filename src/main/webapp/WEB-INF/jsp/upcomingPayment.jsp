			...
			<div class="container-fluid pt-4 px-4">
				<div class="row g-4S">
					...
					<div class="bg-secondary rounded h-100 p-4">
			            ...
			            <c:if test="${empty msg }">
						 <h6 class="mb-4" style="color:red">Upcoming payment details within 7 days</h6>
						</c:if>
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th scope="col" style="color:green">Due Date</th>
									</tr>
								</thead>
								<tbody>
									...
									<c:forEach items="${customerList}" var="customer">
										<tr>
											...
											<td style="color:green"><c:out value="${customer.dueDate }" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
